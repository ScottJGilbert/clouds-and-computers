...
#     apply_velocity_function: Optional[Callable[..., Any]] = None
#     @classmethod
#     def apply_velocity_to_orbital(cls) -> None:
#         if callable(cls.apply_velocity_function):
#             cls.apply_velocity_function()
